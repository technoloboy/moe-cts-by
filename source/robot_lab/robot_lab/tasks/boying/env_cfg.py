...
import robot_lab.tasks.boying.mdp as mdp
from robot_lab.assets.boying import BOYING_CFG
from robot_lab.tasks.boying.mdp.terrains import TERRAIN_CFG
...
class BoyingSceneCfg(InteractiveSceneCfg):
    """Configuration for the terrain scene with the Boying robot."""
...
class RewardsCfg:
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_thigh|.*_calf|head|hm"), "threshold": 5.0},
    )
...
class BoyingEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the Boying robot on rough terrain."""
