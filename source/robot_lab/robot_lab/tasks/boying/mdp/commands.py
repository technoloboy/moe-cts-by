...
'''
@File    : commands.py
@Desc    : CommandTerm for go2_rl_gym style command generation.
           Reference: https://github.com/wty-yy/go2_rl_gym
'''
...
if TYPE_CHECKING:
    from robot_lab.tasks.boying.env.boying_env import BoyingEnv
...
from .utils import is_robot_on_terrain, sample_disjoint_intervals, sample_single_interval
...
class Go2RLGymCommand(CommandTerm):
    ...
    def __init__(self, cfg: Go2RLGymCommandCfg, env: BoyingEnv):
    ...
    def _update_env_command_ranges(self):
        for terrain_type, terrain_command_ranges in self.cfg.terrain_max_command_ranges.items():
            ...
            self.env_command_ranges['lin_vel_x'][env_ids, 0] = max(
                terrain_command_ranges['lin_vel_x'][0], self.command_ranges['lin_vel_x'][0])
            self.env_command_ranges['lin_vel_x'][env_ids, 1] = min(
                terrain_command_ranges['lin_vel_x'][1], self.command_ranges['lin_vel_x'][1])
            self.env_command_ranges['lin_vel_y'][env_ids, 0] = max(
                terrain_command_ranges['lin_vel_y'][0], self.command_ranges['lin_vel_y'][0])
            self.env_command_ranges['lin_vel_y'][env_ids, 1] = min(
                terrain_command_ranges['lin_vel_y'][1], self.command_ranges['lin_vel_y'][1])
            self.env_command_ranges['ang_vel_yaw'][env_ids, 0] = max(
                terrain_command_ranges['ang_vel_yaw'][0], self.command_ranges['ang_vel_yaw'][0])
            self.env_command_ranges['ang_vel_yaw'][env_ids, 1] = min(
                terrain_command_ranges['ang_vel_yaw'][1], self.command_ranges['ang_vel_yaw'][1])
    ...
    def get_current_scale(self, config: dict):
        ...
        return (1.0 - percentage) * cfg_start_val + percentage * cfg_end_val
...
class Go2RLGymCommandCfg(CommandTermCfg):
    ...
    terrain_max_command_ranges: dict[str, dict] = {
        'wave':           {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'slope_up':       {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'slope_down':     {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'rough_slope':    {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'stairs_up':      {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'stairs_down':    {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'obstacles':      {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'stepping_stones':{'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'gap':            {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'flat':           {'lin_vel_x': [-2.0, 2.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-2.0, 2.0]},
        'random_rough':       {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'hf_pyramid_slope':   {'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'hf_pyramid_slope_inv':{'lin_vel_x': [-1.5, 1.5], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'pyramid_stairs':     {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'pyramid_stairs_inv': {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
        'boxes':              {'lin_vel_x': [-1.0, 1.0], 'lin_vel_y': [-1.0, 1.0], 'ang_vel_yaw': [-1.5, 1.5]},
    }
